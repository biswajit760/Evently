  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        size === "default" && "h-9",
        size === "sm" && "h-8",
        // Allow Overrides (Crucial for CategoryFilter to be borderless)
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="ml-2 h-4 w-4 opacity-50 transition-transform duration-200 group-data-[state=open]:rotate-180" />
...
// ... Keep Label, Item, Separator, etc. as they were ... 
// (I will assume you have the standard implementations for these below, 
// they usually don't need changing for this specific UI fix)
...
export {
  ...
  SelectScrollDownButton,
  SelectScrollUpButton,
//   SelectSeparator, // Add if you need it
  SelectTrigger,
  SelectValue,
}