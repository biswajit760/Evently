...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn(
        // Added !z-[9998] to ensure it covers the underlying Select dropdown
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          // FORCE CENTER POSITIONING (High Specificity)
          "!fixed !left-[50%] !top-[50%] !z-[9999] !translate-x-[-50%] !translate-y-[-50%]",
          
          // Layout & Sizing
          "grid w-full max-w-lg gap-4 p-6 border shadow-lg sm:rounded-lg bg-background",
