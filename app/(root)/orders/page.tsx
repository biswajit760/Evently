        ...
        <table className="w-full border-collapse border-t">
          <thead>
            <tr className="p-medium-14 border-b text-grey-500">
              ...
              <th className="min-w-[200px] py-3 pr-4 text-left">Event Title</th>              <th className="min-w-[150px] py-3 text-left">Buyer</th>
                  ...
                  orders.map((row: IOrderItem) => (
                    <tr
                      ...
                      <td className="min-w-[100px] py-4 text-right">
                        {/* FIX: Uncommented formatPrice. row.totalAmount is now a number, which formatPrice should handle */}
